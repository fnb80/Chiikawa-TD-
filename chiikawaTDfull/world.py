...
class World():
    def __init__(self, data, map_image):
        ...
        self.killed_momongas = 0
        self.missed_momongas = 0 
    ...
    def level_check(self):
        if self.spawned_momonga >= len(self.momonga_list):
            return True
        return False
        #return (self.killed_momongas + self.missed_momongas) >= len(self.momonga_list)
        
    def restart_level(self):
        #restart all stats and variables for new level
        self.momonga_list = []
        self.spawned_momonga = 0
        self.killed_momongas = 0
        self.missed_momongas = 0 
    ...
    def next_level(self):
        #advance to the next level and prepare new enemies
        self.level += 1
        self.restart_level()
